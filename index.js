...
// Main Script --------------------------------------------------------------------------------------------
alert("Some part of this website was changed because this is the old version of the KV Chat Bot, this version can understand tagalog only");
var userinput;
var chatbotresponse;
...
var InitialBotResponse, InstantBotResponse, InstantUserInput, MixedResponse;
...
$("document").ready(function () {
    ...
    $("#copy-convo").click(() => {
        ...
        navigator.clipboard.writeText(textContent).then(function() {
            let x = confirm('Na Copy na ang Conversation! \n\nNais mo bang magbigay ng feedback? suggestion? O i share ang inyong convo sa developer?\nOo = Ok\nHindi = Cancel');
            if(x) {
				window.location.href="https://docs.google.com/forms/d/e/1FAIpQLSfnw_qCofoCzr_FpuYd99Q7W5bRCWqXCui-5bgURhtdipY4GA/viewform?usp=sf_link";
			}
		}).catch(function(err) {
    ...
    $("#fixed-menu-button-symbol").click(() => {
        // $("#menu").css("display","block");
        $("#main-content-area").css("filter","blur(10px)");
        $("#menu").css("top","0px");
    });
    $("#menu-close-button").click(() => {
        // $("#menu").css("display","none");
        $("#main-content-area").css("filter","none");
        $("#menu").css("top","-100vh");
    });
